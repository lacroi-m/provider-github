...
[provider-jet-provider-github](https://github.com/crossplane-contrib/provider-jet-provider-github) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/lacroi-m/provider-githubblob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/lacroi-m/provider-githubblob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/lacroi-m/provider-githubblob/main/hack/boilerplate.go.txt](https://github.com/lacroi-m/provider-githubblob/main/hack/boilerplate.go.txt)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/lacroi-m/provider-githubblob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/lacroi-m/provider-githubtree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue provider-githubs (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/lacroi-m/provider-githubtree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request provider-githubs: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/lacroi-m/provider-githubblob/master/.github/PULL_REQUEST_TEMPLATE.md))
