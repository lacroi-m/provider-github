...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider provider-github CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider provider-github controllers
...
# This target prepares repo for your provider by replacing all "provider-github"
